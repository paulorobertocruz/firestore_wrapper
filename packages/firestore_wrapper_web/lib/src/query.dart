...
class Query extends fsw.Query{
  ...
  @override
  Query where(String field, {isEqualTo, isLessThan, isLessThanOrEqualTo, isGreaterThan, isGreaterThanOrEqualTo, arrayContains, bool isNull}) {
    var query = _ref;
